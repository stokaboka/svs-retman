const state = {
  ...
  columns: [
    ...
    { name: 'action', field: 'action', label: 'Действие', align: 'left', sortable: true, visible: true, update: false, insert: true },
    { name: 'result', field: 'result', label: 'Результат', align: 'left', sortable: true, visible: true, update: false, insert: true },
    { name: 'title', field: 'title', label: 'Заголовок', align: 'left', sortable: true, visible: true, update: false, insert: true },
    { name: 'scope', field: 'scope', label: 'Фильтр', align: 'left', sortable: true, visible: true, update: false, insert: true },
    { name: 'text', field: 'text', label: 'Текст', align: 'left', sortable: true, visible: true, update: false, insert: true },
    { name: 'sounds', field: 'sounds', label: 'Звук', align: 'left', sortable: true, visible: true, update: false, insert: true },
