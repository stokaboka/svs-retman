const state = {
  ...
  columns: [
    ...
    { name: 'word1', field: 'word1', label: 'Слово/фраза 1', sortable: true, visible: true, update: false, insert: false },
    { name: 'word2', field: 'word2', label: 'Слово/фраза 2', sortable: true, visible: true, update: false, insert: true },
